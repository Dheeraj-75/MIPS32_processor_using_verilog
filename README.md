...
A pipelined MIPS microprocessor written in VHDL and simulated in Xilinx. Simplified MIPS instruction set. Synthesized and implemented, but never tested on hardware.

## Usage
This project was created using Xilinx Vivado 2025.2. Vivado was version controlled using [vivado-git](https://github.com/barbedo/vivado-git). 
...
![prelab_block_diagram](docs/images/PrelabBlockDiagram.PNG)
...
![selftest_waveform_dec](docs/images/selftest_behav_wavf_signed_decimal.PNG)
...
![fib_waveform_dec](docs/images/FinalFib_behav_wavf_decimal.PNG)
...
![d_mem_table](docs/images/Fib_dataMem_snip_decimal.PNG)
